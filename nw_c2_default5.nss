...
// wired 02/11/2012 if attacked by mounted pc, send them on their way
...
void main()
{
	...
	{
		if (GetIsMounted(oAttacker))
		{
			SendMessageToPC(oAttacker,"You lack the required feats for mounted combat.");
			AssignCommand(oAttacker,ActionMountedCombatStop(OBJECT_SELF));
		}
	}
